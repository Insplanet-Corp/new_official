self.__SERVER_FILES_MANIFEST={
  ...
  "files": [
    ...
    ".next-prod/routes-manifest.json",
    ".next-prod/server/pages-manifest.json",
    ".next-prod/build-manifest.json",
    ".next-prod/prerender-manifest.json",
    ...
    ".next-prod/required-server-files.json"
  ],
  "ignore": []
}