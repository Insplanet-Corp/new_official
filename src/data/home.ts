...
export const PARTNERS: PartnerLogo[] = [
  ...
  { src: "/images/partners/partner-05.png", lw: 104, lh: 28 },
  ...
  { src: "/images/partners/partner-25.png", lw: 147, lh: 33 },
];
...
export const toShowcase = (rows: Portfolio[]): ShowcaseItem[] => {
  ...
  return rows.slice(0, MAX_SHOWCASE).map((r, i) => ({
    ...
    /* 메인 전용 제목이 있으면 그걸 쓴다(026). 비어 있으면 프로젝트명으로 되돌아가므로
       예전 데이터도 그대로 나온다 — 줄바꿈 규칙은 둘 다 같다. */
    name: titleLines(mainTitleOf(r)),
